...
function anyadir($pdo, $table, $valores)
{
   try {
      ...
      else echo '<p class="exito">¡Actividad "', $valores[0], '" registrada con éxito!</p>';
   } catch (PDOException $e) {
      echo "Failed to get DB handle: " . $e->getMessage() . "\n";
      exit;
   }
...
function modificar($pdo, $table, $valores)
{
   try {
      ...
      else echo '<p class="exito">¡Actividad "', $valores[0], '" modificada con éxito!</p>';
   } catch (PDOException $e) {
      echo "Failed to get DB handle: " . $e->getMessage() . "\n";
      exit;
   }
...
function borrar($pdo, $table, $id)
{
   try {
      ...
      else echo '<p class="exito">¡Actividad borrada con éxito!</p>';
   } catch (PDOException $e) {
      echo "Failed to get DB handle: " . $e->getMessage() . "\n";
      exit;
   }
